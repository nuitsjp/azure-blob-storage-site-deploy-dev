...
- [`design.ja.md`](design.ja.md): プロダクト設計（背景・要件・制約・インターフェース）
- `architecture.ja.md`（本書）: 実装構成とスクリプト分割
- [`deploy.ja.md`](deploy.ja.md) / [`cleanup.ja.md`](cleanup.ja.md): 各スクリプトの詳細設計
- [`e2e.ja.md`](e2e.ja.md): E2Eテストの詳細設計
...
**E2Eテスト**: テスト用リポジトリを使い、実Azure環境でライフサイクル全体を検証する。詳細は[`e2e.ja.md`](e2e.ja.md)を参照。

テストの実行方法は[README.ja.md](../README.ja.md)を参照。
