...
| ドキュメント | 内容 |
|---|---|
| [`docs/design.ja.md`](docs/design.ja.md) | プロダクト設計（背景・要件・制約・インターフェース） |
| [`docs/architecture.ja.md`](docs/architecture.ja.md) | 実装構成とスクリプト分割 |
| [`docs/deploy.ja.md`](docs/deploy.ja.md) | deploy.shの詳細設計 |
| [`docs/cleanup.ja.md`](docs/cleanup.ja.md) | cleanup.shの詳細設計 |
| [`docs/e2e.ja.md`](docs/e2e.ja.md) | E2Eテストの詳細設計 |
